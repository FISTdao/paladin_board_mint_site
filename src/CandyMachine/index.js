...
const CandyMachine = ({ walletAddress }) => {
  ...
  const renderDropTimer = () => {
    ...
    return <div>{<div>Use the devnet faucet <a href="https://solfaucet.com/"> here </a> if you need SOL.</div>}</div>;
  };
      ...
      <div className="machine-container">
        ...
        { candyMachine.state.itemsRedeemed === candyMachine.state.itemsAvailable 
          ...
          : (
            ...
            <p>Due to problems with Solana's developer network, it may
              take multiple tries to sucessfully mint. </p>
            </div>
          )
        }
